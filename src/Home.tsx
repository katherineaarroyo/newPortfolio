    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            bridging <em style={{ fontStyle: "italic" }}>product design</em>{" "}
            and
            <br />
            ...
            <div style={{ color: c.text, flex: 1, transition: "color 0.3s" }}>
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: "16px", transition: "color 0.3s" }}>
                    Sorora
                  </div>
                </div>
                <div
              ...
              >
                ...
                <p style={{ marginBottom: "16px" }}>
                  Keep Her Safe is a mobile safety app by Sorora that lets users
                  instantly alert trusted contacts — and emergency services — if
                  needed.
                </p>
                <p style={{ marginBottom: "16px" }}>
                  A business team had built an MVP with live location tracking
                  and a contact list. Our senior project team was brought in to:
                </p>
                <ul style={{ marginLeft: "20px", marginBottom: "30px" }}>
                  ...
                  <li style={{ marginBottom: "8px" }}>
                    Establish a development workflow to support long-term growth
                  </li>
                </ul>
                <p style={{ marginBottom: "40px" }}>
                  As both a designer and developer, I worked across the full
                  product lifecycle — from identifying problems to shipping the
                  redesign.
                </p>
                ...
                >
                  ...
                  >
                    <li style={{ marginBottom: "8px" }}>
                      No visual indicators showing the user's current location
                      in the app
                    </li>
                    <li style={{ marginBottom: "8px" }}>
                      Navigation relied entirely on a back button — no save or
                      exit options
                    </li>
                    <li style={{ marginBottom: "8px" }}>
                      Violated "Recognition over Recall" by forcing users to
                      mentally track their own flow
                    </li>
                  </ul>
                </div>
                ...
                >
                  ...
                  >
                    <li style={{ marginBottom: "8px" }}>
                      Emergency button could be activated too easily, risking
                      accidental contact with law enforcement
                    </li>
                    <li style={{ marginBottom: "8px" }}>
                ...
                >
                  ...
                  >
                    <li style={{ marginBottom: "8px" }}>
                      No clear visual hierarchy — hard to identify the app's
                      primary purpose at a glance
                    </li>
                    <li style={{ marginBottom: "8px" }}>
                      Interactive and static elements looked the same
                    </li>
                    <li style={{ marginBottom: "8px" }}>
                      Settings were fragmented across too many screens with
                ...
                <ul style={{ marginLeft: "20px", marginBottom: "40px" }}>
                  <li style={{ marginBottom: "8px" }}>
                    <strong>Life360</strong> — Referenced their navigation bar
                    pattern for clear wayfinding
                  </li>
                  <li style={{ marginBottom: "8px" }}>
                    <strong>Noonlight</strong> — Their patented deadlock SOS
                    feature (requiring sustained, deliberate interaction)
                    directly informed our error prevention approach
                  </li>
                </ul>
                ...
                <div style={{ marginBottom: "30px" }}>
                  ...
                  <ol style={{ marginLeft: "20px" }}>
                    ...
                    <li style={{ marginBottom: "8px" }}>
                      Added confirmation alerts for SOS and edit actions to
                      prevent errors
                    </li>
                  </ol>
                ...
                <div style={{ marginBottom: "40px" }}>
                  ...
                  <ol style={{ marginLeft: "20px" }}>
                    <li style={{ marginBottom: "8px" }}>
                      Dropped Life360-style map view selector in favor of a
                      cleaner button approach
                    </li>
                    <li style={{ marginBottom: "8px" }}>
                ...
                <p style={{ marginBottom: "30px" }}>
                  The redesign produced measurable gains across accessibility,
                  ergonomics, and user performance:
                </p>
                ...
                >
                  ...
                  >
                    ...
                    >
                      Task completion time — down from 2:48 to 0:51 average
                    </div>
                  </div>
                </div>
              </div>
